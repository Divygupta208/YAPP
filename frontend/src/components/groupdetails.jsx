...
const GroupDetails = ({ groupId, onClose }) => {
    ...
    const fetchGroupDetails = async () => {
      ...
      try {
        const response = await fetch(
          `https://my-api.zapto.org/yapp/api/groups/${groupId}/details`,
          {
  ...
  const handleAddUsers = async () => {
    ...
    try {
      const response = await fetch(
        `https://my-api.zapto.org/yapp/api/groups/${groupId}/add-users`,
        {
          method: "POST",
          headers: {
  ...
  const handleRemoveMember = async (memberId) => {
    ...
    try {
      const response = await fetch(
        `https://my-api.zapto.org/yapp/api/groups/${groupId}/remove-member`,
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleUpdateRole = async (memberId, newRole) => {
    ...
    try {
      const response = await fetch(
        `https://my-api.zapto.org/yapp/api/groups/${groupId}/update-member-role`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleUpdateGroupInfo = async () => {
    ...
    try {
      const response = await fetch(
        `https://my-api.zapto.org/yapp/api/groups/${groupId}/update`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
